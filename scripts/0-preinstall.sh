...
-------------------------------------------------------------------------
"
pacstrap /mnt base base-devel linux linux-lts linux-firmware man-db man-pages texinfo vim sudo archlinux-keyring wget libnewt xterm alacritty bash-completion --noconfirm --needed
